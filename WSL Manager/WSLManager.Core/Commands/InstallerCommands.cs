...
namespace WSLManager.Core.Commands
{
    ...
    public static class InstallerCommands
    {
        ...
        public static string removeFolderFromWindowsFull {get;}= $"/c rmdir /s /q {windowsFolderLocation} ";
        //$"/c Remove-Item {windowsFolderLocation} -Force  -Recurse -ErrorAction SilentlyContinue";
        public static string makeNewFolderWindows {get;}= $"/c mkdir {windowsFolderLocation}";
